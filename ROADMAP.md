...
| K0~K4. K-POP Creation Control | [진행 중] | K0·K1·K2 완료, K3 Analysis 다음 구현 | [K-POP Roadmap](planning/kpop-creation-roadmap.md) |
...
10. [K-POP Creation Roadmap](planning/kpop-creation-roadmap.md)의 K2 Structured Options까지 완료했다. 실제 BPM·Hook timestamp·Audio Analysis는 K3, LoRA·Dataset·Voice 학습은 K4 이후로 유지한다.
