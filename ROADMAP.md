...
| K0~K4. K-POP Creation Control | [진행 중] | K0·K1·K2·K3.0·K3.1 완료, K3.2 Tempo 다음 구현 | [K-POP Roadmap](planning/kpop-creation-roadmap.md) |
...
10. [K-POP Creation Roadmap](planning/kpop-creation-roadmap.md)의 K3.1 Audio Quality Metrics까지 완료했다. 다음은 별도 PR의 K3.2 Tempo이며 Hook·Preview는 K3.3~K3.4, LoRA·Dataset·Voice 학습은 K4 이후로 유지한다.
