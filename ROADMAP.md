...
**최우선 NEXT:** D1-A Backend aggregate read 완료를 전제로 명시적 Workspace bootstrap·최소 backfill인 D1-Transition을 수행한다. 이후 D1-B Frontend 연결을 진행하며, Workspace Job의 실제 Provider transport와 background daemon은 별도 Track으로 유지한다.
