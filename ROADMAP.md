...
10. [K-POP Creation Roadmap](planning/kpop-creation-roadmap.md)의 K1 Preset MVP에서 3종 Preset·Prompt Compiler·Lyrics Template·기존 Pipeline 요청 연결을 구현한다. 구조화 옵션·분석·모델 학습은 K2 이후로 유지한다.
