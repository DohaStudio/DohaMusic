...
| Workspace Artifact Domain | [진행 중] | Entity·Repository·Service, 실제 DB 0012·0013, ProjectAsset Cursor·0014 source 기반과 첫 Resource API 8개 완료; 0014 실제 적용·나머지 56개 API·Artifact 폴더·Runtime 미전환 | [Workspace Artifact 모델](docs/03-architecture/workspace-artifact-model.md) |
