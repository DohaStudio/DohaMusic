...
| Workspace Artifact Domain | [진행 중] | Entity·Repository·Service, 실제 DB 0012~0016과 Resource API 19개 완료; Catalog row 0개, Resolver·ingestion·나머지 45개 API·Artifact 폴더·Runtime 미구현 | [Artifact Storage 계약](docs/03-architecture/artifact-storage-contract.md) |
