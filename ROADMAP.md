...
| Workspace Artifact Domain | [진행 중] | Entity·Repository·Service, 실제 DB 0012~0016, Catalog·Resolver·Trusted Ingestion·owner/retention read Gate·dry-run reconciliation과 Resource API 19개 완료; destructive repair·나머지 45개 API·운영 Artifact 폴더·Runtime 미구현 | [Artifact Storage 계약](docs/03-architecture/artifact-storage-contract.md) |
