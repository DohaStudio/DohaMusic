...
def create_voice_conversion(request: VoiceConversionCreate, service: ServiceDependency) -> VoiceConversionJobRead:
...
def list_voice_conversion_files(job_id: str, service: ServiceDependency) -> list[VoiceConversionFileRead]:
