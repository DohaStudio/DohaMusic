...
down_revision: Union[str, None] = "20260801_0011"
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.UniqueConstraint(
            "asset_id", "version_number", name="uq_asset_versions_number"
        ),
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.UniqueConstraint(
            "name", "chain_version", name="uq_processing_chains_version"
        ),
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_artifacts_media_type"), "artifacts", ["media_type"], unique=False
    )
    op.create_index(
        op.f("ix_artifacts_producer_id"), "artifacts", ["producer_id"], unique=False
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False),
        sa.CheckConstraint(
            "((source_asset_id IS NOT NULL AND target_asset_id IS NOT NULL AND source_asset_version_id IS NULL AND target_asset_version_id IS NULL AND source_asset_id <> target_asset_id) OR (source_asset_id IS NULL AND target_asset_id IS NULL AND source_asset_version_id IS NOT NULL AND target_asset_version_id IS NOT NULL AND source_asset_version_id <> target_asset_version_id))",
            name="ck_asset_relations_exact_pair",
        ),
        sa.ForeignKeyConstraint(
            ["source_asset_id"], ["assets.asset_id"], ondelete="RESTRICT"
        ),
        sa.ForeignKeyConstraint(
        ...
        sa.ForeignKeyConstraint(
            ["target_asset_id"], ["assets.asset_id"], ondelete="RESTRICT"
        ),
        sa.ForeignKeyConstraint(
    ...
    op.create_index(
        op.f("ix_comments_created_by"), "comments", ["created_by"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_favorites_asset_id"), "favorites", ["asset_id"], unique=False
    )
    op.create_index(
        op.f("ix_favorites_deleted_at"), "favorites", ["deleted_at"], unique=False
    )
    op.create_index(
        op.f("ix_favorites_workspace_id"), "favorites", ["workspace_id"], unique=False
    )
    op.create_table(
        "history",
    ...
    op.create_index(
        op.f("ix_history_entity_id"), "history", ["entity_id"], unique=False
    )
    op.create_index(
        op.f("ix_history_entity_type"), "history", ["entity_type"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_history_workspace_id"), "history", ["workspace_id"], unique=False
    )
    op.create_table(
        "music_projects",
    ...
    op.create_index(
        op.f("ix_music_projects_title"), "music_projects", ["title"], unique=False
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False),
        sa.CheckConstraint(
            "step_order >= 1", name="ck_processing_steps_positive_order"
        ),
        sa.ForeignKeyConstraint(
            ["processing_chain_id"],
            ["processing_chains.processing_chain_id"],
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["project_id"], ["music_projects.project_id"], ondelete="RESTRICT"
        ),
    ...
    op.create_index(
        op.f("ix_project_assets_role"), "project_assets", ["role"], unique=False
    )
    op.create_table(
        "jobs",
        ...
        sa.ForeignKeyConstraint(
            ["retry_of_job_id"], ["jobs.job_id"], ondelete="RESTRICT"
        ),
    ...
    op.create_index(
        op.f("ix_jobs_error_details_id"), "jobs", ["error_details_id"], unique=False
    )
    op.create_index(op.f("ix_jobs_job_type"), "jobs", ["job_type"], unique=False)
    op.create_index(
        op.f("ix_jobs_model_manifest_id"), "jobs", ["model_manifest_id"], unique=False
    )
    op.create_index(
        "ix_jobs_project_created", "jobs", ["project_id", "created_at"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_jobs_requested_by"), "jobs", ["requested_by"], unique=False
    )
    op.create_index(
        op.f("ix_jobs_retry_of_job_id"), "jobs", ["retry_of_job_id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False),
        sa.CheckConstraint(
            "(asset_version_id IS NOT NULL AND artifact_id IS NULL) OR (asset_version_id IS NULL AND artifact_id IS NOT NULL)",
    ...
    op.create_index(
        op.f("ix_job_inputs_artifact_id"), "job_inputs", ["artifact_id"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_job_inputs_job_id"), "job_inputs", ["job_id"], unique=False
    )
    op.create_table(
        "job_outputs",
    ...
    op.create_index(
        op.f("ix_job_outputs_job_id"), "job_outputs", ["job_id"], unique=False
    )
    op.create_table(
        "model_usages",
    ...
    op.create_index(
        op.f("ix_model_usages_job_id"), "model_usages", ["job_id"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_model_usages_model_id"), "model_usages", ["model_id"], unique=False
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False),
        sa.CheckConstraint(
            "(CASE WHEN asset_version_id IS NOT NULL THEN 1 ELSE 0 END + CASE WHEN recording_enrollment_id IS NOT NULL THEN 1 ELSE 0 END + CASE WHEN model_usage_id IS NOT NULL THEN 1 ELSE 0 END) = 1",
    ...
    op.create_index(
        op.f("ix_approvals_approved_by"), "approvals", ["approved_by"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_approvals_decided_at"), "approvals", ["decided_at"], unique=False
    )
    op.create_index(
        op.f("ix_approvals_evidence_id"), "approvals", ["evidence_id"], unique=False
    )
    op.create_index(
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_model_usages_commercial_usage_status"), table_name="model_usages"
    )
    op.drop_index(op.f("ix_model_usages_asset_version_id"), table_name="model_usages")
    op.drop_index(
        op.f("ix_model_usages_api_contract_version"), table_name="model_usages"
    )
    ...
    op.drop_index(
        op.f("ix_snapshot_items_composition_snapshot_id"), table_name="snapshot_items"
    )
    op.drop_index(
        op.f("ix_snapshot_items_asset_version_id"), table_name="snapshot_items"
    )
    ...
    op.drop_index(
        op.f("ix_composition_snapshots_project_id"), table_name="composition_snapshots"
    )
    op.drop_index(
        "ix_composition_snapshots_project_created", table_name="composition_snapshots"
    )
    op.drop_index(
        op.f("ix_composition_snapshots_processing_chain_id"),
    ...
    op.drop_index(
        op.f("ix_composition_snapshots_created_by"), table_name="composition_snapshots"
    )
    ...
    op.drop_index(
        op.f("ix_recording_enrollments_status"), table_name="recording_enrollments"
    )
    op.drop_index(
        op.f("ix_recording_enrollments_recording_asset_version_id"),
        table_name="recording_enrollments",
    ...
    op.drop_index(
        op.f("ix_recording_enrollments_deleted_at"), table_name="recording_enrollments"
    )
    op.drop_index(
        op.f("ix_recording_enrollments_created_by"), table_name="recording_enrollments"
    )
    op.drop_index(
        op.f("ix_recording_enrollments_consent_policy_version"),
        table_name="recording_enrollments",
    ...
    op.drop_index(
        op.f("ix_processing_steps_processing_chain_id"), table_name="processing_steps"
    )
    ...
    op.drop_index(
        op.f("ix_music_projects_lifecycle_status"), table_name="music_projects"
    )
    ...
    op.drop_index(
        op.f("ix_asset_relations_target_asset_version_id"), table_name="asset_relations"
    )
    op.drop_index(
        op.f("ix_asset_relations_target_asset_id"), table_name="asset_relations"
    )
    op.drop_index(
        op.f("ix_asset_relations_source_asset_version_id"), table_name="asset_relations"
    )
    op.drop_index(
        op.f("ix_asset_relations_source_asset_id"), table_name="asset_relations"
    )
    op.drop_index(
        op.f("ix_asset_relations_relation_type"), table_name="asset_relations"
    )
    ...
    op.drop_index(
        op.f("ix_processing_chains_created_by"), table_name="processing_chains"
    )
    ...
    op.drop_index(
        op.f("ix_asset_versions_processing_chain_id"), table_name="asset_versions"
    )
    op.drop_index(
        op.f("ix_asset_versions_parent_asset_version_id"), table_name="asset_versions"
    )
    op.drop_index(
        op.f("ix_asset_versions_model_manifest_id"), table_name="asset_versions"
    )
