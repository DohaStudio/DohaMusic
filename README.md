...
- [ADR-040](docs/11-decisions/ADR-040-canonical-track-clip-working-composition-authority.md)·[ADR-045](docs/11-decisions/ADR-045-clip-service-deletion-media-duration-authority.md)·[ADR-050](docs/11-decisions/ADR-050-working-composition-inverse-mutation-authority.md)·[ADR-052](docs/11-decisions/ADR-052-working-composition-preview-render-authority.md)에서 mutable WorkingComposition, canonical Track·Clip, trusted source duration, inverse mutation과 revision-pinned Preview 소유권을 확정했다. persistence, atomic mutation Service와 18개 Product operation, Frontend Track/Clip 편집·memory Undo/Redo, exact AssetVersion-safe media resolution·Clip별 source-window Waveform, non-canonical Preview Asset/AssetVersion/Artifact Backend foundation을 구현했다. Preview Frontend integration과 Composition commit은 미구현이다.
...
- Working Preview Frontend integration·Section·Mixer·range selection, persistent history와 Composition commit
...
- 현재 제품 단계: D1 Composition Read Workspace [완료] / D2 Timeline Playback·Master/Mix Waveform·Richer Playhead [완료] / D3 WorkingComposition Backend·Frontend Clip Editing·memory Undo/Redo·Track/Clip Waveform·Working Preview Backend Foundation [진행 중] / NEXT: Working Preview Frontend Integration
