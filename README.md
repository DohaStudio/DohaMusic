...
- 현재 제품 단계: D1 Composition Read Workspace [완료] / D2 Timeline Playback·Master/Mix Waveform·Richer Playhead [완료] / D3 WorkingComposition Backend·Frontend Clip Editing·Clip Copy·memory Undo/Redo·Track/Clip Waveform·Working Preview·Composition Commit Integration·Clip Gain Backend Foundation [진행 중] / NEXT: Clip Gain Frontend UI 또는 Fade·Loop 중 단일 D3 gate
