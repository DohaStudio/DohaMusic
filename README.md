...
Installation bootstrap의 [ADR-076](docs/11-decisions/ADR-076-product-deployment-bootstrap-authority.md)은 #162로 채택/merged됐다. 후속 [issuance-integrity verifier Foundation](docs/03-architecture/bootstrap-issuance-integrity-verifier.md)은 별도 Draft PR에서 Ed25519/JCS 무결성만 검증한다. 결과는 bootstrap 권한이 아니며 trusted provisioning/current status/journal/claim/principal binding/WebAuthn·production runtime는 아직 미구현이다.
