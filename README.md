...
- [ADR-040](docs/11-decisions/ADR-040-canonical-track-clip-working-composition-authority.md)·[ADR-045](docs/11-decisions/ADR-045-clip-service-deletion-media-duration-authority.md)·[ADR-050](docs/11-decisions/ADR-050-working-composition-inverse-mutation-authority.md)·[ADR-052](docs/11-decisions/ADR-052-working-composition-preview-render-authority.md)·[ADR-053](docs/11-decisions/ADR-053-clip-gain-authority.md)에서 mutable WorkingComposition, canonical Track·Clip, trusted source duration, inverse mutation, Composition Commit history barrier, revision-pinned Preview와 Clip Gain을 확정했다. persistence, atomic mutation Service와 21개 Product operation, Frontend Track/Clip 편집·explicit Clip Copy·memory Undo/Redo, exact AssetVersion-safe media resolution·Clip별 source-window Waveform, non-canonical Preview Backend/Frontend integration, immutable Composition Commit과 selected Clip Gain UI를 구현했다.
...
- 현재 제품 단계: D1 Composition Read Workspace [완료] / D2 Timeline Playback·Master/Mix Waveform·Richer Playhead [완료] / D3 WorkingComposition Backend·Frontend Clip Editing·Clip Copy·memory Undo/Redo·Track/Clip Waveform·Working Preview·Composition Commit·Clip Gain Integration [진행 중] / NEXT: Fade Authority / Foundation
