...
| Composition Runtime UI | [진행 중] | D1·D2와 D3 WorkingComposition·Working Preview·Composition Commit Backend/Frontend integration, Track/Clip editing·explicit Clip Copy·memory Undo/Redo, exact AssetVersion-safe media source·Track/Clip Waveform·Clip Gain Backend foundation 완료; Gain UI·Fade·Loop·Section·Mixer 미구현 |
...
| AI-native DAW Product | [진행 중] | `D0·D1·D2·D3 WorkingComposition·Working Preview·Composition Commit Backend/Frontend integration·Clip editing·Clip Copy·safe media source·Track/Clip Waveform·Clip Gain Backend foundation 완료` | 9개 persistence table·21개 Product operation·memory Undo/Redo·exact version media resolution·Clip source-window Waveform·revision-pinned Preview·immutable Commit·static Clip Gain 완료; Gain UI·Fade·Loop·실제 DB 적용·Section·Mixer·QA·Learning 미구현 | [AI-native DAW DoD](docs/DoD/AI-Native-DAW.md) |
...
Clip Gain Frontend UI 또는 Fade·Loop 중 단일 D3 editing gate [다음]
```
