...
| Composition Runtime UI | [진행 중] | D1·D2와 D3 WorkingComposition Backend, Frontend Track/Clip editing·memory Undo/Redo, exact AssetVersion-safe media source Backend 완료; Track/Clip Waveform Frontend·Composition commit·Section·Mixer 미구현 |
...
F6       Guided Voice Enrollment     [진행 중]
  ↓ 독립 장기 전환
Track    AI-native DAW Product       [D0·D1·D2·D3 Backend/Frontend Clip editing·safe media source 완료 / D3 Waveform Frontend·commit 후속 / D4~D9 계획]
  ↓
...
| AI-native DAW Product | [진행 중] | `D0·D1·D2·D3 WorkingComposition Backend·Frontend Clip editing·safe media source 완료` | 5개 persistence table·17개 mutation operation·memory Undo/Redo·exact version media resolution 완료; Track/Clip Waveform Frontend·Composition commit·실제 DB 적용·Section·Mixer·QA·Learning 미구현 | [AI-native DAW DoD](docs/DoD/AI-Native-DAW.md) |
...
AssetVersion-safe media source Backend [완료]
  ↓
Track/Clip Waveform Frontend [다음]
```
