...
| Composition Runtime UI | [진행 중] | D1·D2와 D3 WorkingComposition·Working Preview·Composition Commit Backend/Frontend integration, Track/Clip editing·memory Undo/Redo, exact AssetVersion-safe media source·Track/Clip Waveform 완료; Section·Mixer 미구현 |
...
| AI-native DAW Product | [진행 중] | `D0·D1·D2·D3 WorkingComposition·Working Preview·Composition Commit Backend/Frontend integration·Clip editing·safe media source·Track/Clip Waveform 완료` | 9개 persistence table·19개 Product operation·memory Undo/Redo·exact version media resolution·Clip source-window Waveform·revision-pinned Preview·immutable Commit 완료; 실제 DB 적용·Section·Mixer·QA·Learning 미구현 | [AI-native DAW DoD](docs/DoD/AI-Native-DAW.md) |
...
Mixer 또는 잔여 D3 editing gate [다음]
```
