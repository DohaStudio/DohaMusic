...
| Composition Runtime UI | [진행 중] | D1·D2와 D3 WorkingComposition Backend, Frontend Track/Clip editing·memory Undo/Redo, exact AssetVersion-safe media source·Track/Clip Waveform 완료; working preview/render·Composition commit·Section·Mixer 미구현 |
...
F6       Guided Voice Enrollment     [진행 중]
  ↓ 독립 장기 전환
Track    AI-native DAW Product       [D0·D1·D2·D3 Backend/Frontend Clip editing·safe media source·Track/Clip Waveform 완료 / D3 preview·commit 후속 / D4~D9 계획]
  ↓
...
| AI-native DAW Product | [진행 중] | `D0·D1·D2·D3 WorkingComposition Backend·Frontend Clip editing·safe media source·Track/Clip Waveform 완료` | 5개 persistence table·17개 mutation operation·memory Undo/Redo·exact version media resolution·Clip source-window Waveform 완료; working preview/render·Composition commit·실제 DB 적용·Section·Mixer·QA·Learning 미구현 | [AI-native DAW DoD](docs/DoD/AI-Native-DAW.md) |
...
Track/Clip Waveform Frontend [완료]
  ↓
Working preview/render [다음]
```

이 순서는 기존 Phase·품질 평가·Provider 분리 Track을 취소하지 않는다. D1-B와 WorkingComposition persistence·Service·Product API·safe media resolution 완료는 source·격리 fixture 기준이며 실제 사용자 DB `0017 → 0023` 적용을 뜻하지 않는다.
