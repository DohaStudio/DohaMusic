...
| Workspace Artifact·Job Domain | [진행 중] | 독립 체크리스트 | 실제 DB 0012~0017, Job schema·Index·Cursor·Repository keyset·Service state/cancel/retry 기반과 Artifact·CompositionSnapshot API 완료; Worker·Completion UoW·API 0/5와 나머지 39개 API 미구현 | [Workspace Job Foundation](docs/03-architecture/workspace-job-foundation.md) |
