...
| Composition Runtime UI | [진행 중] | D1·D2와 D3 WorkingComposition Backend, Frontend Track/Clip editing·memory Undo/Redo 완료; Track/Clip Waveform·Composition commit·Section·Mixer 미구현 |
...
F6       Guided Voice Enrollment     [진행 중]
  ↓ 독립 장기 전환
Track    AI-native DAW Product       [D0·D1·D2·D3 Backend/Frontend Clip editing 완료 / D3 Waveform·commit 후속 / D4~D9 계획]
  ↓
...
| AI-native DAW Product | [진행 중] | `D0·D1·D2·D3 WorkingComposition Backend·Frontend Clip editing 완료` | 5개 persistence table·17개 Product operation·memory Undo/Redo 완료; Track/Clip Waveform·Composition commit·실제 DB 적용·Section·Mixer·QA·Learning 미구현 | [AI-native DAW DoD](docs/DoD/AI-Native-DAW.md) |
