...
| Composition Runtime UI | [진행 중] | D1·D2와 D3 WorkingComposition persistence·Service·17개 Product operation 및 Backend inverse mutation 완료; Frontend Track/Clip·Undo/Redo·Composition commit·Section·Mixer 미구현 |
...
| AI-native DAW Product | [진행 중] | `D0·D1·D2·WorkingComposition Backend inverse mutation 완료 / D3 Frontend 후속 진행 중` | 5개 persistence table·trusted duration·atomic mutation Service·17개 Product operation 완료; Frontend Undo/Redo·Composition commit·실제 DB 적용·Section·Mixer·QA·Learning 미구현 | [AI-native DAW DoD](docs/DoD/AI-Native-DAW.md) |
