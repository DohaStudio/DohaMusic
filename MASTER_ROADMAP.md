...
| AI Provider 저장소 분리 | [진행 중] | 독립 체크리스트 | DohaVocal Runtime·Consumer Contract Foundation 구현, Production transport·Artifact 통합 미구현 | [DohaVocal Consumer Contract](docs/03-architecture/dohavocal-consumer-contract.md) |
