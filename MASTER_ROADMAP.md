...
| F6. Guided Voice Enrollment | [진행 중] | 독립 체크리스트 | Backend와 Frontend Wizard·MediaRecorder·품질·대표 선택·복원 완료, 실제 FFmpeg·scheduler·인증 미구현 | [Frontend Roadmap](planning/frontend-roadmap.md#f6--guided-voice-enrollment-진행-중) |
...
- 남은 gap: Windows·CI FFmpeg 실제 WebM/Ogg 통합, 주기적 expiration·cleanup scheduler와 crash 복구, chunk resume, 동의 철회·파생 삭제, 실제 사용자 수동 녹음·브라우저 MIME 평가.
