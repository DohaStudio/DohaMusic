...
class PreviewBackend {
  ...
  private working(id: string) {
    return {
      ...
      clips: [{ clip_id: clipId, track_id: trackId, source_asset_version_id: assetVersionId, timeline_start: "0.000", source_in: "0.000", source_out: "2.000", source_duration: "2.000", split_from_clip_id: null }],
