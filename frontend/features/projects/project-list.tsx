...
export function ProjectList() {
  ...
  return <section className="collection-page">
    <header className="collection-header"><div><p className="eyebrow">프로젝트</p><h1>음악을 주제별로 정리하세요</h1><p>앨범이나 작업 목적에 따라 만든 음악을 묶어 관리할 수 있습니다.</p></div><Link className="button secondary" href="/history">만든 음악 보기</Link></header>
