...
export function ProjectList() {
  ...
  return <section className="collection-page">
    <header className="collection-header"><div><p className="eyebrow">프로젝트 · DAW</p><h1>프로젝트에서 곡을 편집하세요</h1><p>음악을 주제별로 정리하고 각 프로젝트의 DAW에서 트랙과 클립을 편집할 수 있습니다.</p></div><Link className="button secondary" href="/history">만든 음악 보기</Link></header>
