...
10. renderer V1은 최대 64 Tracks, 512 Clips, 30분, input Artifact당 128 MiB, output 384 MiB, 300초 timeout이다. WAV·FLAC·trusted MP3를 decode하고 trim, timeline offset, silence, cross-Track overlap과 deterministic mix를 지원한다. Pan·Mute·Solo·automation·fade·loop·mastering·Export codec은 지원하지 않는다.
