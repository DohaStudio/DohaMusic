...
| [ADR-102](ADR-102-durable-admission-orchestration-foundation.md) | CurrentnessWitness·AdmissionAttempt·Transaction Owner·Commit Reconciler의 fail-closed durable admission 조정 | Foundation Draft·production composition 아님 |
