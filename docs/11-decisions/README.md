...
| [ADR-038](ADR-038-v1-reviewer-authentication-product-decision.md) | V1 reviewer authentication product 후보의 근거 재판정 | 보류, product-owner 결정 필요 |
...
- [ADR-038 — V1 Reviewer Authentication Product Decision](ADR-038-v1-reviewer-authentication-product-decision.md): CURRENT MVP와 V1 production을 분리하고 reviewer population·interaction 근거 부재로 product 후보와 Provider-model readiness를 보류한다.
