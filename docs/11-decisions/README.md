...
| [ADR-084](ADR-084-designation-provenance-reader-input-contract.md) | independent designation/provisioning semantic input·partial observation·live snapshot 계약 | docs-only 제안; 실제 reader 미구현, 운영 비활성 |
