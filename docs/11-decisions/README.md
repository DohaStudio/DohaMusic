...
| [ADR-095](ADR-095-active-provisioning-verifier-material-foundation.md) | held ACTIVE authority projection과 custody-bound exact Ed25519 verifier bytes 결합 | Foundation Draft·signature/currentness/admission 아님 |
