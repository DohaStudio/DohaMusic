...
| [ADR-040](ADR-040-trusted-payload-locator-authority.md) | DohaMusic-owned opaque Trusted Payload locator authority | 승인 |
...
- [ADR-040 — Trusted Payload Locator Authority](ADR-040-trusted-payload-locator-authority.md): Provider path·URI를 배제하고 DohaMusic runtime만 발급하는 opaque locator와 trusted staging resolver 경계를 승인한다.
