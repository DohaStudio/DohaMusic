...
| [ADR-101](ADR-101-admission-commit-reconciler-foundation.md) | opaque ambiguous-commit handoff의 complete journal read-only exact reconciliation | Foundation Draft·orchestration/admission 아님 |
