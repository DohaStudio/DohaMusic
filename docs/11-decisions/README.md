...
| [ADR-088](ADR-088-initializer-provenance-action-binding-foundation.md) | strict installation/action/initializer/policy binding 및 terminal history 비교 | Foundation Draft·public facts는 권한이 아님 |
