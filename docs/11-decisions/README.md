...
| [ADR-081](ADR-081-provider-witness-lifetime-foundation.md) | provider-internal opaque handle/exact binding/lease·transaction lifetime mechanics; authorization 아님 | Foundation 구현·로컬 Gate PASS, 별도 Draft; 운영 비활성 |
