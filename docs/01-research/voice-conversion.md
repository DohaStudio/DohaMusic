...
Seed-VC의 `seed-uvit-whisper-base-f0-44k` 계열을 Phase 4 검증 Provider로 선택했다. 소스 보컬의 F0를 유지하도록 설계된 44.1kHz singing voice conversion 모델이며, 훈련 없이 1~30초 참조 음성을 받는 공식 CLI가 이번 입력 계약과 직접 일치한다.
