...
> 구현 상태: `/api/v1` Resource Endpoint 30개, D1 Product API 2개, WorkingComposition Product operation 18개와 exact AssetVersion media source read 1개 구현; Workspace Job API 5/5, 나머지 Resource 34개 미구현
