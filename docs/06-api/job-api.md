...
현재 Resource API는 25/64, Workspace Job API는 0/5다. Entity 역할·cancellation marker·claim/lease·Cursor/Index Migration과 completion Unit of Work를 구현·검증하기 전에는 이 API를 완료로 표시하지 않는다.
