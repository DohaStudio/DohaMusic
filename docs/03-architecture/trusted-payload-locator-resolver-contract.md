...
> 문서 상태: [완료: process-local locator 호환 adapter, durable schema/Runtime, verified staging·acquisition] / [계약 확정·미구현: Completion adapter·Worker wiring]
> 최종 수정일: 2026-08-25
