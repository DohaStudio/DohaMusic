...
Workspace Entity 29개를 사용하는 Application Use Case와 transaction 경계를 정의한다. Clip persistence와 PayloadLocator Repository도 같은 Service-owned transaction 원칙을 따르며 기존 Runtime Repository·Service·API는 변경하지 않는다.
