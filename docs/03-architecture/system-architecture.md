...
| CompositionSnapshot | 불변 Snapshot Entity·Application·API와 Working/Track/Clip persistence·atomic mutation Service·Product API 존재 | Track·Clip 편집 UI와 후보 commit Workflow 미구현 |
