...
| CompositionSnapshot | 불변 Snapshot Entity·Application·API, Working/Track/Clip persistence·atomic mutation Service·22개 Product API와 Frontend Clip Copy·Commit·Gain/Fade UI 존재 | Loop·persistent history·multi-user recovery·Section·Mixer 미구현 |
