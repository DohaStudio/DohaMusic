...
| CompositionSnapshot | 불변 Snapshot Entity·Application·API와 Working/Track/Clip·Snapshot arrangement persistence 기반 존재 | Track·Clip 편집 Service/API/UI와 후보 commit Workflow 미구현 |
