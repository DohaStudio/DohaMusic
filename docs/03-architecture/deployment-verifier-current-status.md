...
[ADR-081 helper](../11-decisions/ADR-081-provider-witness-lifetime-foundation.md) #167, [ADR-082 Windows serialization](../11-decisions/ADR-082-windows-ceremony-serialization-foundation.md) #168, [ADR-083 pin facts](../11-decisions/ADR-083-private-pin-facts-reader-foundation.md) #169와 [ADR-084 provenance Contract](../11-decisions/ADR-084-designation-provenance-reader-input-contract.md) #170은 merged다. 다음 [ADR-085 record snapshot mechanics](../11-decisions/ADR-085-designation-record-snapshot-foundation.md)는 fixed raw read/digest/live pin identity/sealed snapshot/currentness lifetime 대조만 구현한다. 실제 human provenance/ACL custody authenticity/current eligibility/full reader는 미구현이다. file/digest/snapshot/helper/mutex는 authorization이 아니며 production ports는 unconditional unavailable다.
