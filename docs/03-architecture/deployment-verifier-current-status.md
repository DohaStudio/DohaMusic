...
[ADR-081 helper](../11-decisions/ADR-081-provider-witness-lifetime-foundation.md) #167, [ADR-082 Windows serialization](../11-decisions/ADR-082-windows-ceremony-serialization-foundation.md) #168, [ADR-083 pin facts](../11-decisions/ADR-083-private-pin-facts-reader-foundation.md) #169, [ADR-084 provenance Contract](../11-decisions/ADR-084-designation-provenance-reader-input-contract.md) #170 및 [ADR-085 snapshot mechanics](../11-decisions/ADR-085-designation-record-snapshot-foundation.md) #172는 merged다. 다음 [ADR-086 custody policy mechanics](../11-decisions/ADR-086-designation-source-custody-policy-foundation.md)는 independently injected root/record identity·owner/protected binary DACL을 same-handle 비교·fresh handoff 재검사한다. 실제 independent policy provisioning/initializer human provenance/designation authenticity/current eligibility/full reader는 미구현이다. file/digest/snapshot/policy/ACL/helper/mutex는 authorization이 아니며 production ports는 unconditional unavailable다.
