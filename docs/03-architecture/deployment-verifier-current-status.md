...
[ADR-081 helper](../11-decisions/ADR-081-provider-witness-lifetime-foundation.md) #167, [ADR-082 Windows serialization](../11-decisions/ADR-082-windows-ceremony-serialization-foundation.md) #168, [ADR-083 pin facts](../11-decisions/ADR-083-private-pin-facts-reader-foundation.md) #169, [ADR-084 provenance Contract](../11-decisions/ADR-084-designation-provenance-reader-input-contract.md) #170, [ADR-085 snapshot](../11-decisions/ADR-085-designation-record-snapshot-foundation.md) #172, [ADR-086 custody](../11-decisions/ADR-086-designation-source-custody-policy-foundation.md) #173 및 [ADR-087 linkage Contract](../11-decisions/ADR-087-custody-policy-provisioning-initializer-provenance-contract.md) #174는 merged다. 다음 [ADR-088 strict public binding Foundation](../11-decisions/ADR-088-initializer-provenance-action-binding-foundation.md)은 exact policy/action/initializer/pin 및 terminal history 비교만 구현한 Draft다. actual original-confirmation authenticity/live source/current lineage reader·policy store CAS는 미구현이다. comparison/digest/ACL/current enum/mutex는 admission/authorization이 아니며 production ports는 unconditional unavailable다.
