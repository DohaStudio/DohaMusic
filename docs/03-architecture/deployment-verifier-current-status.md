...
[ADR-081 helper Foundation](../11-decisions/ADR-081-provider-witness-lifetime-foundation.md) #167, [ADR-082 Windows serialization](../11-decisions/ADR-082-windows-ceremony-serialization-foundation.md) #168, [ADR-083 private pin facts reader](../11-decisions/ADR-083-private-pin-facts-reader-foundation.md) #169는 merged다. 다음 [ADR-084 designation provenance reader 입력·snapshot Contract](../11-decisions/ADR-084-designation-provenance-reader-input-contract.md)는 독립 source·partial observation·live handoff의 docs-only 제안이다. 실제 provenance reader는 미구현이다. private file facts/서명/helper/mutex는 authorization이 아니다. custody/provenance·fresh journal/history·authoritative manifest/possession/currentness·durable admission/pin install은 후속이며 production ports는 unconditional unavailable다.
