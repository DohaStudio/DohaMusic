...
[ADR-081 helper](../11-decisions/ADR-081-provider-witness-lifetime-foundation.md) #167, [ADR-082 Windows serialization](../11-decisions/ADR-082-windows-ceremony-serialization-foundation.md) #168, [ADR-083 pin facts](../11-decisions/ADR-083-private-pin-facts-reader-foundation.md) #169, [ADR-084 provenance Contract](../11-decisions/ADR-084-designation-provenance-reader-input-contract.md) #170, [ADR-085 snapshot mechanics](../11-decisions/ADR-085-designation-record-snapshot-foundation.md) #172 및 [ADR-086 custody mechanics](../11-decisions/ADR-086-designation-source-custody-policy-foundation.md) #173는 merged다. 다음 [ADR-087 policy/action/initializer linkage Contract](../11-decisions/ADR-087-custody-policy-provisioning-initializer-provenance-contract.md)는 original designation·initializer 위임·실제 provisioning action·exact installed policy·fresh current lineage를 연결하는 docs-only Draft다. actual authenticated provisioning/provenance source·designation eligibility/full reader는 미구현이다. file/digest/snapshot/policy/ACL/metadata/helper/mutex는 authorization이 아니며 production ports는 unconditional unavailable다.
