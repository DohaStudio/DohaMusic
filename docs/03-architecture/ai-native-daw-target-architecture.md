...
| 영역 | 현재 Gap |
|---|---|
| Composition edit model | ADR-040·ADR-050·ADR-052·ADR-053·ADR-054·ADR-055와 9개 persistence table·Service·23개 Product operation, Frontend explicit Clip Copy UI·memory Undo/Redo·Working Preview·Composition Commit 및 Clip Gain/Fade/Loop Backend/Frontend integration 구현 |
