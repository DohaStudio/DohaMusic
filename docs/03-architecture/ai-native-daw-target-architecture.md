...
[ADR-040](../11-decisions/ADR-040-canonical-track-clip-working-composition-authority.md)은 mutable WorkingComposition과 canonical Track·Clip, exact AssetVersion과 불변 Snapshot commit 경계를 설계했다. ADR-045·047·050·052·053·054·055 authority와 schema·Repository·trusted duration·idempotency foundation, [atomic mutation Service](working-composition-service.md), 23개 Product operation, Frontend Track/Clip editing·explicit Clip Copy·memory Undo/Redo, exact source-window Waveform, Working Preview 및 Composition Commit Backend/Frontend integration, Clip Gain/Fade와 Loop Backend foundation을 구현했다. Loop Frontend는 미구현이며 D1 snapshot-local projection은 계속 canonical Track이 아니다.
...
| 영역 | 현재 Gap |
|---|---|
| Composition edit model | ADR-040·ADR-050·ADR-052·ADR-053·ADR-054·ADR-055와 9개 persistence table·Service·23개 Product operation, Frontend explicit Clip Copy UI·memory Undo/Redo·Working Preview·Composition Commit Backend/Frontend integration·Clip Gain/Fade와 Loop Backend foundation 구현; Loop Frontend 미구현 |
