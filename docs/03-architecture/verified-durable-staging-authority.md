...
Artifact ingestion/Completion production adapter, reclaim, dispatcher, daemon, production authentication, DohaVocal Runtime과 model/GPU는 후속 작업이다. Completion 계약은 [ADR-069](../11-decisions/ADR-069-dohavocal-verified-staged-artifact-completion-authority.md)을 따른다.
