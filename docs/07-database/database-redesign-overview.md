...
> 구현 상태: 목표 Workspace Entity 21개·Catalog·Job schema·Index `0017` 실제 DB 적용, Job Service state/cancel/retry 기반과 Resource API 25개 완료·Job API 0/5; 실제 Bootstrap·backfill·dual write 미수행
