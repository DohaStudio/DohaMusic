...
- Project·effective Owner·선택 Composition Snapshot·동적 Manifest·idempotency fingerprint와 기존 다른 Provider의 `voice_conversion` 호환성을 유지했다. 공개 Job 생성 request contract는 확장되지만 Endpoint·DB·Alembic·Worker·Provider 실행·Artifact ingestion은 변경하지 않았다.
