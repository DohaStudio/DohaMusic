...
- Owner-scoped create/history/latest Service와 restart recovery, cross-Workspace retry, logical ID validation, transaction rollback을 검증한다. Provider status·Public API·Worker wiring·Provider 호출·Artifact ingestion은 추가하지 않았다.
